...
function MinisterCont(props) {
    ...
    return (
        <div className={mode ? " lg:w-10/12 pl-14 bg-gray-950 shadow-2xl pb-5 sm:pb-0 sm:pt-0 sm:pl-0  xl:flex hover:w-11/12 m-auto cursor-pointer duration-300 rounded-lg min-h-[15em] mt-5" : "w-10/12 pl-14 pb-5 sm:pb-0 sm:pt-0 sm:pl-0 xl:flex hover:w-11/12 m-auto bg-stone-50 cursor-pointer duration-300 rounded-lg min-h-[15em] mt-5"}>
            <div className="">
                <img src={props.MinImage} className="pr-10 sm:pr-0 md:w-[20em] lg:h-[15em] hover:scale-110 rounded-lg duration-300"/>
            </div>
            <div className="min-h-[6em] hover:block sm:ml-10 mt-5">
