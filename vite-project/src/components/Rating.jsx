...
function Rating() {
    ...
    const { RatingCpt,setRatingCpt } = useContext(MyContext)
    ...
    <form onSubmit={HandleRating}>
        <div className={RatingCpt ? "flex flex-col gap-10 p-5 w-4/6 items-center bg-stone-50 rounded-xl min-h-[2oem] m-auto" : "hidden"}>
            <div className="flex pt-4">
                <p className="text-slate-700 font-bold">How did we do?</p>
                <FaWindowClose onClick={()=>setRatingCpt(false)} className="relative left-56 cursor-pointer"/>
            </div>
          ...
          is appreciated to help us improve our offering!</p>
            ...
            <label htmlFor="input" className="flex flex-col gap-3 relative top-[-1em]">
                <p></p>
                <input type="text" className="w-[29em] pb-10 outline-1 outline-orange-300 rounded-lg p-5 text-[.7em]" value={feedback} placeholder="give us feedback here..." required onChange={(e)=>{setfeedback(e.target.value)}}/>
