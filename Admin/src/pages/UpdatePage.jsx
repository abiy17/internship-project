...
function UpdatePage() {
    ...
    const HandleSubmit=(e)=>{
        axios.post(`http://localhost:5000/updateDepartment/${uniqueId}`,{department,description,direction})
    ...
    return ( 
        <div className="update flex flex-col gap-5">
            ...
            <div className="w-11/12 min-h-[35em] bg-white rounded-lg m-auto">
                ...
                <form onSubmit={(e)=>HandleSubmit} action="http://localhost:5000/updateDepartment" className="h-[30em] bg-gray-100 flex flex-col gap-8 p-5 mt-5 w-[60%] m-auto" >
