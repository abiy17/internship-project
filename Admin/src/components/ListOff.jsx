        ...
        <div className="">
                <li className="w-[80%] flex rounded m-auto bg-zinc-100 list-none min-h-[2.5em] p-5">{props.Officials.slice(0,50)}
                    <div className="absolute left-[57em] flex gap-10">
                            <NavLink ><button onClick={()=>HandleClick(props._id)} className="w-[6.5em] h-[2em] bg-slate-700 text-white font-semibold rounded-md hover:opacity-60 duration-300 active:opacity-40">update</button></NavLink>
